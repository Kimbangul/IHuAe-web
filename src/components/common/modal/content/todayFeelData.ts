import { TodayFeelIconPropsType } from './TodayFeelIcon';
...
const todayFeelData: TodayFeelIconPropsType[] = [
  { icon: FEEL01_37, name: '평온', width: '3.7rem', height: '3.85rem' },
  { icon: FEEL02_47, name: '무덤덤', width: '5.5rem', height: '5.9rem' },
  { icon: FEEL03_24, name: '슬픔', width: '2.4rem', height: '3.65rem' },
  { icon: FEEL04_40, name: '분노', width: '4rem', height: '4rem' },
